...
public class ParkingFloor {
    ...
    private final Map<ParkingSpotType, Map<Integer, ParkingSpot>> availableSpots;
    private final Map<ParkingSpotType, Map<Integer, ParkingSpot>> occupiedSpots;
    private final Map<Integer, ParkingSpot> spotMap;
